...
Input: bovienii_core_genes.core.fasta (from PopCOGenT), RAxML_bipartitionsBranchLabels.Xenorhabdus_52_bestML (RaxML tree generated, unrooted) 
...
Output: Files saved with the prefix ClonalFrame , in directory "unrooted"
...
Input: bovienii_core_genes.core.fasta (from PopCOGenT), 
RAxML_bipartitionsBranchLabels.Xenorhabdus_52_bestML_rooted  (RaxML tree generated, rooted on iTol to X.bovienii BU)

Command:  ../ClonalFrameML RAxML_bipartitionsBranchLabels.Xenorhabdus_52_bestML_rooted bovienii_core_genes.core.fasta ClonalFrame_rooted -emsim 100 -label_uncorrected_tree true -output_filtered true

Output: Files saved with the prefix "ClonalFrame_rooted"
...
###################################################################################################################################################################################
Also noticed in the paper that the clonalfrmaeML was calculated for 42 isolates only. Since the core genes didnt change in Roary the old ClonalFrameML result should be the same. 
Didnt change this - saved to bov42genomes_mugsyAlignment
