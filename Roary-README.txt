...
Input files : The off files from prokka output for just the 53 X. Bovienii genomes. 
Saved in /Users/bhavyapapudeshi/Library/CloudStorage/OneDrive-IndianaUniversity/BovGenomeShared/gff-bov

Command: roary gff-bov/* -p 10 -f bov-53-90pid-rerun2022 -e -n -I 90 -z 

Output: Saved under bov-53-90pid-rerun2022 directory. The list of genes and clusters are saved in "gene_presence_and_absence.csv"

Visualising the gene presence and absence as UMAP
